...
export default function FilterComponent({
  ...
  return (
    <div className={`mb-5 rounded-lg flex gap-2`}>
      <label
        className={`px-2 w-32 text-left border-2 border-amber-300 py-2 relative rounded-lg text-gray-500 outline-none`}
      ...
      <button
        ...
        } rounded-lg border-2 hover:border-amber-600 hover:bg-amber-600 right-0 inline-block px-2 py-1 aspect-square font-semibold uppercase text-white`}
        onClick={onClear}
      >
        <Close size={20} />
      </button>
